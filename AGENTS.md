...
> **Claude Code / OpenAI Codex:** The full AI agent instructions for this project live in
> `.nexus/ai/instructions.md`. Read that file before doing anything.
>
> This file exists at the root because Claude Code / OpenAI Codex requires it here.
